...
python scripts/run_suite.py --preset iscsic_main_nenv16_v2 --device cuda
python scripts/plot_results.py --input-dir outputs/iscsic_main_nenv16_v2/evaluations --output-dir outputs/iscsic_main_nenv16_v2/figures --runs-dir outputs/iscsic_main_nenv16_v2/runs
python scripts/plot_trajectories.py --runs-dir outputs/iscsic_main_nenv16_v2/runs --output-dir outputs/iscsic_main_nenv16_v2/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/iscsic_main_nenv16_v2/runs`
- TensorBoard：`outputs/iscsic_main_nenv16_v2/runs/*/tensorboard`
- 评估 CSV：`outputs/iscsic_main_nenv16_v2/evaluations`
- 论文图：`outputs/iscsic_main_nenv16_v2/figures`
...
proposed  ppo     0.00     0.90            0.9842       0.00         0.00  0.00 570.6179
proposed  ppo     0.08     0.76            0.9289       0.12         0.00  0.12 523.6332
proposed  ppo     0.15     0.48            0.7910       0.40         0.02  0.42 428.9679
```
