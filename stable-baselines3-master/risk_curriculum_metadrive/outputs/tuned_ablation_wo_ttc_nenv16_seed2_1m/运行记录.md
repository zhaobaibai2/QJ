...
python scripts/run_suite.py --preset tuned_ablation_wo_ttc_nenv16_seed2_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_ablation_wo_ttc_nenv16_seed2_1m/evaluations --output-dir outputs/tuned_ablation_wo_ttc_nenv16_seed2_1m/figures --runs-dir outputs/tuned_ablation_wo_ttc_nenv16_seed2_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_ablation_wo_ttc_nenv16_seed2_1m/runs --output-dir outputs/tuned_ablation_wo_ttc_nenv16_seed2_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_ablation_wo_ttc_nenv16_seed2_1m/runs`
- TensorBoard：`outputs/tuned_ablation_wo_ttc_nenv16_seed2_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_ablation_wo_ttc_nenv16_seed2_1m/evaluations`
- 论文图：`outputs/tuned_ablation_wo_ttc_nenv16_seed2_1m/figures`
...
proposed_wo_ttc  ppo     0.00     0.96            0.9897       0.00          0.0  0.00 517.0932
proposed_wo_ttc  ppo     0.08     0.96            0.9587       0.04          0.0  0.04 483.7971
proposed_wo_ttc  ppo     0.15     0.52            0.8209       0.34          0.0  0.34 376.3947
```
