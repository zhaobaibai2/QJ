...
python scripts/run_suite.py --preset tuned_compare_curriculum_nenv16_seed0_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_compare_curriculum_nenv16_seed0_1m/evaluations --output-dir outputs/tuned_compare_curriculum_nenv16_seed0_1m/figures --runs-dir outputs/tuned_compare_curriculum_nenv16_seed0_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_compare_curriculum_nenv16_seed0_1m/runs --output-dir outputs/tuned_compare_curriculum_nenv16_seed0_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_compare_curriculum_nenv16_seed0_1m/runs`
- TensorBoard：`outputs/tuned_compare_curriculum_nenv16_seed0_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_compare_curriculum_nenv16_seed0_1m/evaluations`
- 论文图：`outputs/tuned_compare_curriculum_nenv16_seed0_1m/figures`
...
curriculum  ppo     0.00     0.02            0.3502       0.00         0.98  0.98 131.8833
curriculum  ppo     0.08     0.00            0.2559       0.32         0.68  1.00  84.0313
curriculum  ppo     0.15     0.00            0.1765       0.56         0.44  1.00  53.6515
```
