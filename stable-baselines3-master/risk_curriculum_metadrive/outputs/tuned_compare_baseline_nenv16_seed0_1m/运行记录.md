...
python scripts/run_suite.py --preset tuned_compare_baseline_nenv16_seed0_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_compare_baseline_nenv16_seed0_1m/evaluations --output-dir outputs/tuned_compare_baseline_nenv16_seed0_1m/figures --runs-dir outputs/tuned_compare_baseline_nenv16_seed0_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_compare_baseline_nenv16_seed0_1m/runs --output-dir outputs/tuned_compare_baseline_nenv16_seed0_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_compare_baseline_nenv16_seed0_1m/runs`
- TensorBoard：`outputs/tuned_compare_baseline_nenv16_seed0_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_compare_baseline_nenv16_seed0_1m/evaluations`
- 论文图：`outputs/tuned_compare_baseline_nenv16_seed0_1m/figures`
...
baseline  ppo     0.00     0.02            0.3016       0.00         0.98  0.98 67.4473
baseline  ppo     0.08     0.00            0.2345       0.40         0.60  1.00 53.9647
baseline  ppo     0.15     0.00            0.1769       0.62         0.38  1.00 44.2203
```
