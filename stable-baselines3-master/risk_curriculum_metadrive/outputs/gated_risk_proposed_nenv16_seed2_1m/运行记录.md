...
python scripts/run_suite.py --preset gated_risk_proposed_nenv16_seed2_1m --device cuda
python scripts/plot_results.py --input-dir outputs/gated_risk_proposed_nenv16_seed2_1m/evaluations --output-dir outputs/gated_risk_proposed_nenv16_seed2_1m/figures --runs-dir outputs/gated_risk_proposed_nenv16_seed2_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/gated_risk_proposed_nenv16_seed2_1m/runs --output-dir outputs/gated_risk_proposed_nenv16_seed2_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/gated_risk_proposed_nenv16_seed2_1m/runs`
- TensorBoard：`outputs/gated_risk_proposed_nenv16_seed2_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/gated_risk_proposed_nenv16_seed2_1m/evaluations`
- 论文图：`outputs/gated_risk_proposed_nenv16_seed2_1m/figures`
...
proposed_gated_risk  ppo     0.00     0.94            0.9897       0.00          0.0  0.00 497.1405
proposed_gated_risk  ppo     0.08     0.90            0.9629       0.06          0.0  0.06 456.8580
proposed_gated_risk  ppo     0.15     0.56            0.8368       0.28          0.0  0.28 412.4806
```
