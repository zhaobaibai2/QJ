...
python scripts/run_suite.py --preset tuning_ttc12_v16_nenv10_500k --device cuda
python scripts/plot_results.py --input-dir outputs/tuning_ttc12_v16_nenv10_500k/evaluations --output-dir outputs/tuning_ttc12_v16_nenv10_500k/figures --runs-dir outputs/tuning_ttc12_v16_nenv10_500k/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuning_ttc12_v16_nenv10_500k/runs --output-dir outputs/tuning_ttc12_v16_nenv10_500k/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuning_ttc12_v16_nenv10_500k/runs`
- TensorBoard：`outputs/tuning_ttc12_v16_nenv10_500k/runs/*/tensorboard`
- 评估 CSV：`outputs/tuning_ttc12_v16_nenv10_500k/evaluations`
- 论文图：`outputs/tuning_ttc12_v16_nenv10_500k/figures`
...
proposed  ppo     0.00     0.84            0.9751       0.00          0.0  0.00 548.7928
proposed  ppo     0.08     0.76            0.9438       0.08          0.0  0.08 519.7235
proposed  ppo     0.15     0.52            0.8567       0.22          0.0  0.22 465.0878
```
