...
python scripts/run_suite.py --preset tuned_ablation_guard_only_nenv16_seed2_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_ablation_guard_only_nenv16_seed2_1m/evaluations --output-dir outputs/tuned_ablation_guard_only_nenv16_seed2_1m/figures --runs-dir outputs/tuned_ablation_guard_only_nenv16_seed2_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_ablation_guard_only_nenv16_seed2_1m/runs --output-dir outputs/tuned_ablation_guard_only_nenv16_seed2_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_ablation_guard_only_nenv16_seed2_1m/runs`
- TensorBoard：`outputs/tuned_ablation_guard_only_nenv16_seed2_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_ablation_guard_only_nenv16_seed2_1m/evaluations`
- 论文图：`outputs/tuned_ablation_guard_only_nenv16_seed2_1m/figures`
...
guard_only  ppo     0.00     0.96            0.9901       0.00          0.0  0.00 553.6026
guard_only  ppo     0.08     0.88            0.9332       0.10          0.0  0.10 528.4091
guard_only  ppo     0.15     0.62            0.8468       0.24          0.0  0.24 459.4586
```
