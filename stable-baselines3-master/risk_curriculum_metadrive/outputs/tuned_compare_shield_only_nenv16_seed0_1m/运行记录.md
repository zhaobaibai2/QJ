...
python scripts/run_suite.py --preset tuned_compare_shield_only_nenv16_seed0_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_compare_shield_only_nenv16_seed0_1m/evaluations --output-dir outputs/tuned_compare_shield_only_nenv16_seed0_1m/figures --runs-dir outputs/tuned_compare_shield_only_nenv16_seed0_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_compare_shield_only_nenv16_seed0_1m/runs --output-dir outputs/tuned_compare_shield_only_nenv16_seed0_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_compare_shield_only_nenv16_seed0_1m/runs`
- TensorBoard：`outputs/tuned_compare_shield_only_nenv16_seed0_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_compare_shield_only_nenv16_seed0_1m/evaluations`
- 论文图：`outputs/tuned_compare_shield_only_nenv16_seed0_1m/figures`
...
shield_only  ppo     0.00     1.00            0.9917       0.00         0.00  0.00 563.6507
shield_only  ppo     0.08     0.96            0.9749       0.02         0.02  0.04 536.2633
shield_only  ppo     0.15     0.56            0.8329       0.32         0.00  0.32 433.2982
```
