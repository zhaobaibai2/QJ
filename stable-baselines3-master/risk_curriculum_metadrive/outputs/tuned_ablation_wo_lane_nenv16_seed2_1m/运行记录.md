...
python scripts/run_suite.py --preset tuned_ablation_wo_lane_nenv16_seed2_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_ablation_wo_lane_nenv16_seed2_1m/evaluations --output-dir outputs/tuned_ablation_wo_lane_nenv16_seed2_1m/figures --runs-dir outputs/tuned_ablation_wo_lane_nenv16_seed2_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_ablation_wo_lane_nenv16_seed2_1m/runs --output-dir outputs/tuned_ablation_wo_lane_nenv16_seed2_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_ablation_wo_lane_nenv16_seed2_1m/runs`
- TensorBoard：`outputs/tuned_ablation_wo_lane_nenv16_seed2_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_ablation_wo_lane_nenv16_seed2_1m/evaluations`
- 论文图：`outputs/tuned_ablation_wo_lane_nenv16_seed2_1m/figures`
...
proposed_wo_lane  ppo     0.00     1.00            0.9921       0.00          0.0  0.00 388.5776
proposed_wo_lane  ppo     0.08     0.94            0.9798       0.02          0.0  0.02 367.6907
proposed_wo_lane  ppo     0.15     0.60            0.8140       0.28          0.0  0.28 301.5340
```
