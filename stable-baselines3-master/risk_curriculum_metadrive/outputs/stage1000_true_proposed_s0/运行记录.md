...
python scripts/run_suite.py --preset stage1000_true_proposed_s0 --device cuda
python scripts/plot_results.py --input-dir outputs/stage1000_true_proposed_s0/evaluations --output-dir outputs/stage1000_true_proposed_s0/figures --runs-dir outputs/stage1000_true_proposed_s0/runs
python scripts/plot_trajectories.py --runs-dir outputs/stage1000_true_proposed_s0/runs --output-dir outputs/stage1000_true_proposed_s0/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/stage1000_true_proposed_s0/runs`
- TensorBoard：`outputs/stage1000_true_proposed_s0/runs/*/tensorboard`
- 评估 CSV：`outputs/stage1000_true_proposed_s0/evaluations`
- 论文图：`outputs/stage1000_true_proposed_s0/figures`
...
proposed  ppo     0.00     0.84            0.9741       0.00         0.00  0.00 426.7407
proposed  ppo     0.08     0.78            0.9472       0.06         0.00  0.06 422.0627
proposed  ppo     0.15     0.42            0.7215       0.48         0.02  0.50 316.7152
```
