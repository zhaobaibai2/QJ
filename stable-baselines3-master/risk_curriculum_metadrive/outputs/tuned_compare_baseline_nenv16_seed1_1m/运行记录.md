...
python scripts/run_suite.py --preset tuned_compare_baseline_nenv16_seed1_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_compare_baseline_nenv16_seed1_1m/evaluations --output-dir outputs/tuned_compare_baseline_nenv16_seed1_1m/figures --runs-dir outputs/tuned_compare_baseline_nenv16_seed1_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_compare_baseline_nenv16_seed1_1m/runs --output-dir outputs/tuned_compare_baseline_nenv16_seed1_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_compare_baseline_nenv16_seed1_1m/runs`
- TensorBoard：`outputs/tuned_compare_baseline_nenv16_seed1_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_compare_baseline_nenv16_seed1_1m/evaluations`
- 论文图：`outputs/tuned_compare_baseline_nenv16_seed1_1m/figures`
...
baseline  ppo     0.00      0.0            0.2783       0.00         1.00   1.0 104.5788
baseline  ppo     0.08      0.0            0.2708       0.56         0.44   1.0  96.7250
baseline  ppo     0.15      0.0            0.1885       0.58         0.42   1.0  62.4532
```
