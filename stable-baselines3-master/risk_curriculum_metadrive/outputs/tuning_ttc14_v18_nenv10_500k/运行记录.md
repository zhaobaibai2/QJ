...
python scripts/run_suite.py --preset tuning_ttc14_v18_nenv10_500k --device cuda
python scripts/plot_results.py --input-dir outputs/tuning_ttc14_v18_nenv10_500k/evaluations --output-dir outputs/tuning_ttc14_v18_nenv10_500k/figures --runs-dir outputs/tuning_ttc14_v18_nenv10_500k/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuning_ttc14_v18_nenv10_500k/runs --output-dir outputs/tuning_ttc14_v18_nenv10_500k/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuning_ttc14_v18_nenv10_500k/runs`
- TensorBoard：`outputs/tuning_ttc14_v18_nenv10_500k/runs/*/tensorboard`
- 评估 CSV：`outputs/tuning_ttc14_v18_nenv10_500k/evaluations`
- 论文图：`outputs/tuning_ttc14_v18_nenv10_500k/figures`
...
proposed  ppo     0.00     1.00            0.9914       0.00          0.0  0.00 504.6687
proposed  ppo     0.08     0.78            0.8884       0.20          0.0  0.20 459.8527
proposed  ppo     0.15     0.48            0.8289       0.32          0.0  0.32 401.7969
```
