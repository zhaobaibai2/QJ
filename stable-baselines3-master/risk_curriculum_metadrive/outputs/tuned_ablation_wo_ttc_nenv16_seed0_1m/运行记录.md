...
python scripts/run_suite.py --preset tuned_ablation_wo_ttc_nenv16_seed0_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_ablation_wo_ttc_nenv16_seed0_1m/evaluations --output-dir outputs/tuned_ablation_wo_ttc_nenv16_seed0_1m/figures --runs-dir outputs/tuned_ablation_wo_ttc_nenv16_seed0_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_ablation_wo_ttc_nenv16_seed0_1m/runs --output-dir outputs/tuned_ablation_wo_ttc_nenv16_seed0_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_ablation_wo_ttc_nenv16_seed0_1m/runs`
- TensorBoard：`outputs/tuned_ablation_wo_ttc_nenv16_seed0_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_ablation_wo_ttc_nenv16_seed0_1m/evaluations`
- 论文图：`outputs/tuned_ablation_wo_ttc_nenv16_seed0_1m/figures`
...
proposed_wo_ttc  ppo     0.00     1.00            0.9917       0.00          0.0  0.00 511.4336
proposed_wo_ttc  ppo     0.08     0.92            0.9752       0.04          0.0  0.04 490.4801
proposed_wo_ttc  ppo     0.15     0.44            0.7433       0.54          0.0  0.54 361.6740
```
