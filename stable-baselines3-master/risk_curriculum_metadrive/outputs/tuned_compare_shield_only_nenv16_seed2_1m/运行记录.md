...
python scripts/run_suite.py --preset tuned_compare_shield_only_nenv16_seed2_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_compare_shield_only_nenv16_seed2_1m/evaluations --output-dir outputs/tuned_compare_shield_only_nenv16_seed2_1m/figures --runs-dir outputs/tuned_compare_shield_only_nenv16_seed2_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_compare_shield_only_nenv16_seed2_1m/runs --output-dir outputs/tuned_compare_shield_only_nenv16_seed2_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_compare_shield_only_nenv16_seed2_1m/runs`
- TensorBoard：`outputs/tuned_compare_shield_only_nenv16_seed2_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_compare_shield_only_nenv16_seed2_1m/evaluations`
- 论文图：`outputs/tuned_compare_shield_only_nenv16_seed2_1m/figures`
...
shield_only  ppo     0.00     1.00            0.9922       0.00         0.00  0.00 600.8905
shield_only  ppo     0.08     0.86            0.9585       0.06         0.02  0.08 547.4996
shield_only  ppo     0.15     0.76            0.9132       0.14         0.00  0.14 502.1229
```
