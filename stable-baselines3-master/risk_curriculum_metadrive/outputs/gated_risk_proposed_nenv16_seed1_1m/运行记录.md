...
python scripts/run_suite.py --preset gated_risk_proposed_nenv16_seed1_1m --device cuda
python scripts/plot_results.py --input-dir outputs/gated_risk_proposed_nenv16_seed1_1m/evaluations --output-dir outputs/gated_risk_proposed_nenv16_seed1_1m/figures --runs-dir outputs/gated_risk_proposed_nenv16_seed1_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/gated_risk_proposed_nenv16_seed1_1m/runs --output-dir outputs/gated_risk_proposed_nenv16_seed1_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/gated_risk_proposed_nenv16_seed1_1m/runs`
- TensorBoard：`outputs/gated_risk_proposed_nenv16_seed1_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/gated_risk_proposed_nenv16_seed1_1m/evaluations`
- 论文图：`outputs/gated_risk_proposed_nenv16_seed1_1m/figures`
...
proposed_gated_risk  ppo     0.00     0.94            0.9847       0.00          0.0  0.00 588.5011
proposed_gated_risk  ppo     0.08     0.80            0.9549       0.10          0.0  0.10 567.6288
proposed_gated_risk  ppo     0.15     0.62            0.8495       0.28          0.0  0.28 449.2159
```
