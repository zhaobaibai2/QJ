...
python scripts/run_suite.py --preset tuned_ablation_wo_lane_nenv16_seed0_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_ablation_wo_lane_nenv16_seed0_1m/evaluations --output-dir outputs/tuned_ablation_wo_lane_nenv16_seed0_1m/figures --runs-dir outputs/tuned_ablation_wo_lane_nenv16_seed0_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_ablation_wo_lane_nenv16_seed0_1m/runs --output-dir outputs/tuned_ablation_wo_lane_nenv16_seed0_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_ablation_wo_lane_nenv16_seed0_1m/runs`
- TensorBoard：`outputs/tuned_ablation_wo_lane_nenv16_seed0_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_ablation_wo_lane_nenv16_seed0_1m/evaluations`
- 论文图：`outputs/tuned_ablation_wo_lane_nenv16_seed0_1m/figures`
...
proposed_wo_lane  ppo     0.00      1.0            0.9918       0.00          0.0  0.00 383.1767
proposed_wo_lane  ppo     0.08      0.9            0.9570       0.06          0.0  0.06 383.1109
proposed_wo_lane  ppo     0.15      0.6            0.8619       0.28          0.0  0.28 340.1822
```
