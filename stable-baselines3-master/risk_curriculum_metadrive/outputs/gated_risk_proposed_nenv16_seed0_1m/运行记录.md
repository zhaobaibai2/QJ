...
python scripts/run_suite.py --preset gated_risk_proposed_nenv16_seed0_1m --device cuda
python scripts/plot_results.py --input-dir outputs/gated_risk_proposed_nenv16_seed0_1m/evaluations --output-dir outputs/gated_risk_proposed_nenv16_seed0_1m/figures --runs-dir outputs/gated_risk_proposed_nenv16_seed0_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/gated_risk_proposed_nenv16_seed0_1m/runs --output-dir outputs/gated_risk_proposed_nenv16_seed0_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/gated_risk_proposed_nenv16_seed0_1m/runs`
- TensorBoard：`outputs/gated_risk_proposed_nenv16_seed0_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/gated_risk_proposed_nenv16_seed0_1m/evaluations`
- 论文图：`outputs/gated_risk_proposed_nenv16_seed0_1m/figures`
...
proposed_gated_risk  ppo     0.00     0.94            0.9883       0.00          0.0  0.00 541.0590
proposed_gated_risk  ppo     0.08     0.90            0.9641       0.08          0.0  0.08 504.1309
proposed_gated_risk  ppo     0.15     0.62            0.8620       0.20          0.0  0.20 439.8348
```
