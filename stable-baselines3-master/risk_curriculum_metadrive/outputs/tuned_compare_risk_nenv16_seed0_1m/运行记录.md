...
python scripts/run_suite.py --preset tuned_compare_risk_nenv16_seed0_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_compare_risk_nenv16_seed0_1m/evaluations --output-dir outputs/tuned_compare_risk_nenv16_seed0_1m/figures --runs-dir outputs/tuned_compare_risk_nenv16_seed0_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_compare_risk_nenv16_seed0_1m/runs --output-dir outputs/tuned_compare_risk_nenv16_seed0_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_compare_risk_nenv16_seed0_1m/runs`
- TensorBoard：`outputs/tuned_compare_risk_nenv16_seed0_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_compare_risk_nenv16_seed0_1m/evaluations`
- 论文图：`outputs/tuned_compare_risk_nenv16_seed0_1m/figures`
...
variant algo  density  success  route_completion  collision  out_of_road  cost  reward
   risk  ppo     0.00      0.0            0.0089        0.0          0.0   0.0  0.0162
   risk  ppo     0.08      0.0            0.0093        0.0          0.0   0.0  0.0100
   risk  ppo     0.15      0.0            0.0085        0.0          0.0   0.0  0.0061
```
