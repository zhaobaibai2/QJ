...
python scripts/run_suite.py --preset tuned_ablation_guard_only_nenv16_seed0_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_ablation_guard_only_nenv16_seed0_1m/evaluations --output-dir outputs/tuned_ablation_guard_only_nenv16_seed0_1m/figures --runs-dir outputs/tuned_ablation_guard_only_nenv16_seed0_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_ablation_guard_only_nenv16_seed0_1m/runs --output-dir outputs/tuned_ablation_guard_only_nenv16_seed0_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_ablation_guard_only_nenv16_seed0_1m/runs`
- TensorBoard：`outputs/tuned_ablation_guard_only_nenv16_seed0_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_ablation_guard_only_nenv16_seed0_1m/evaluations`
- 论文图：`outputs/tuned_ablation_guard_only_nenv16_seed0_1m/figures`
...
guard_only  ppo     0.00     1.00            0.9917       0.00         0.00  0.00 582.8757
guard_only  ppo     0.08     0.86            0.9542       0.08         0.00  0.08 531.6131
guard_only  ppo     0.15     0.62            0.8614       0.20         0.02  0.22 433.3295
```
