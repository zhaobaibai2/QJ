...
python scripts/run_suite.py --preset stage600_nenv4_guarded --device cuda
python scripts/plot_results.py --input-dir outputs/stage600_nenv4_guarded/evaluations --output-dir outputs/stage600_nenv4_guarded/figures --runs-dir outputs/stage600_nenv4_guarded/runs
python scripts/plot_trajectories.py --runs-dir outputs/stage600_nenv4_guarded/runs --output-dir outputs/stage600_nenv4_guarded/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/stage600_nenv4_guarded/runs`
- TensorBoard：`outputs/stage600_nenv4_guarded/runs/*/tensorboard`
- 评估 CSV：`outputs/stage600_nenv4_guarded/evaluations`
- 论文图：`outputs/stage600_nenv4_guarded/figures`
...
proposed  ppo     0.00     0.52            0.9268       0.00          0.0  0.00 327.7126
proposed  ppo     0.08     0.42            0.8646       0.18          0.0  0.18 308.4437
proposed  ppo     0.15     0.22            0.6115       0.68          0.0  0.68 219.9868
```
