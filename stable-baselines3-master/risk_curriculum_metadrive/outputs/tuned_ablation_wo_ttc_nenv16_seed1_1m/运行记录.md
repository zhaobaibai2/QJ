...
python scripts/run_suite.py --preset tuned_ablation_wo_ttc_nenv16_seed1_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_ablation_wo_ttc_nenv16_seed1_1m/evaluations --output-dir outputs/tuned_ablation_wo_ttc_nenv16_seed1_1m/figures --runs-dir outputs/tuned_ablation_wo_ttc_nenv16_seed1_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_ablation_wo_ttc_nenv16_seed1_1m/runs --output-dir outputs/tuned_ablation_wo_ttc_nenv16_seed1_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_ablation_wo_ttc_nenv16_seed1_1m/runs`
- TensorBoard：`outputs/tuned_ablation_wo_ttc_nenv16_seed1_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_ablation_wo_ttc_nenv16_seed1_1m/evaluations`
- 论文图：`outputs/tuned_ablation_wo_ttc_nenv16_seed1_1m/figures`
...
proposed_wo_ttc  ppo     0.00     1.00            0.9917       0.00          0.0  0.00 572.5233
proposed_wo_ttc  ppo     0.08     0.82            0.9167       0.12          0.0  0.12 533.6575
proposed_wo_ttc  ppo     0.15     0.66            0.9045       0.20          0.0  0.20 488.4494
```
