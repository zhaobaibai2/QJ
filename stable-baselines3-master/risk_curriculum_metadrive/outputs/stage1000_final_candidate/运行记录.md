...
python scripts/run_suite.py --preset stage1000_final_candidate --device cuda
python scripts/plot_results.py --input-dir outputs/stage1000_final_candidate/evaluations --output-dir outputs/stage1000_final_candidate/figures --runs-dir outputs/stage1000_final_candidate/runs
python scripts/plot_trajectories.py --runs-dir outputs/stage1000_final_candidate/runs --output-dir outputs/stage1000_final_candidate/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/stage1000_final_candidate/runs`
- TensorBoard：`outputs/stage1000_final_candidate/runs/*/tensorboard`
- 评估 CSV：`outputs/stage1000_final_candidate/evaluations`
- 论文图：`outputs/stage1000_final_candidate/figures`
...
proposed  ppo     0.00     0.84            0.9741        0.0         0.00  0.00 490.0705
proposed  ppo     0.08     0.74            0.9167        0.1         0.00  0.10 453.8865
proposed  ppo     0.15     0.48            0.7609        0.4         0.02  0.42 350.3364
```
