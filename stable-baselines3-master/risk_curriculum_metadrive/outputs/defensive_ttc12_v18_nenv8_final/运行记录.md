...
python scripts/run_suite.py --preset defensive_ttc12_v18_nenv8_final --device cuda
python scripts/plot_results.py --input-dir outputs/defensive_ttc12_v18_nenv8_final/evaluations --output-dir outputs/defensive_ttc12_v18_nenv8_final/figures --runs-dir outputs/defensive_ttc12_v18_nenv8_final/runs
python scripts/plot_trajectories.py --runs-dir outputs/defensive_ttc12_v18_nenv8_final/runs --output-dir outputs/defensive_ttc12_v18_nenv8_final/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/defensive_ttc12_v18_nenv8_final/runs`
- TensorBoard：`outputs/defensive_ttc12_v18_nenv8_final/runs/*/tensorboard`
- 评估 CSV：`outputs/defensive_ttc12_v18_nenv8_final/evaluations`
- 论文图：`outputs/defensive_ttc12_v18_nenv8_final/figures`
...
proposed  ppo     0.00     0.96            0.9900       0.00         0.00  0.00 509.1733
proposed  ppo     0.08     0.78            0.9074       0.20         0.00  0.20 454.1739
proposed  ppo     0.15     0.60            0.8518       0.22         0.02  0.24 392.1269
```
