...
python scripts/run_suite.py --preset stage1000_true_proposed_s3_nenv8 --device cuda
python scripts/plot_results.py --input-dir outputs/stage1000_true_proposed_s3_nenv8/evaluations --output-dir outputs/stage1000_true_proposed_s3_nenv8/figures --runs-dir outputs/stage1000_true_proposed_s3_nenv8/runs
python scripts/plot_trajectories.py --runs-dir outputs/stage1000_true_proposed_s3_nenv8/runs --output-dir outputs/stage1000_true_proposed_s3_nenv8/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/stage1000_true_proposed_s3_nenv8/runs`
- TensorBoard：`outputs/stage1000_true_proposed_s3_nenv8/runs/*/tensorboard`
- 评估 CSV：`outputs/stage1000_true_proposed_s3_nenv8/evaluations`
- 论文图：`outputs/stage1000_true_proposed_s3_nenv8/figures`
...
proposed  ppo     0.00     0.84            0.9745       0.00         0.00  0.00 516.3089
proposed  ppo     0.08     0.74            0.9175       0.10         0.02  0.12 472.0343
proposed  ppo     0.15     0.34            0.7236       0.56         0.02  0.58 310.8271
```
