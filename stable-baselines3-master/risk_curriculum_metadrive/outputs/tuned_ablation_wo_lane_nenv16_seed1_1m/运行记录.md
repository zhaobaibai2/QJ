...
python scripts/run_suite.py --preset tuned_ablation_wo_lane_nenv16_seed1_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_ablation_wo_lane_nenv16_seed1_1m/evaluations --output-dir outputs/tuned_ablation_wo_lane_nenv16_seed1_1m/figures --runs-dir outputs/tuned_ablation_wo_lane_nenv16_seed1_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_ablation_wo_lane_nenv16_seed1_1m/runs --output-dir outputs/tuned_ablation_wo_lane_nenv16_seed1_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_ablation_wo_lane_nenv16_seed1_1m/runs`
- TensorBoard：`outputs/tuned_ablation_wo_lane_nenv16_seed1_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_ablation_wo_lane_nenv16_seed1_1m/evaluations`
- 论文图：`outputs/tuned_ablation_wo_lane_nenv16_seed1_1m/figures`
...
proposed_wo_lane  ppo     0.00     0.88            0.9870       0.00          0.0  0.00 394.1942
proposed_wo_lane  ppo     0.08     0.90            0.9710       0.10          0.0  0.10 408.4164
proposed_wo_lane  ppo     0.15     0.62            0.8556       0.28          0.0  0.28 338.8034
```
