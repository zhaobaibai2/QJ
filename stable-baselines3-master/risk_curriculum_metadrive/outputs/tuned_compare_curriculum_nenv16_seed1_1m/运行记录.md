...
python scripts/run_suite.py --preset tuned_compare_curriculum_nenv16_seed1_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_compare_curriculum_nenv16_seed1_1m/evaluations --output-dir outputs/tuned_compare_curriculum_nenv16_seed1_1m/figures --runs-dir outputs/tuned_compare_curriculum_nenv16_seed1_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_compare_curriculum_nenv16_seed1_1m/runs --output-dir outputs/tuned_compare_curriculum_nenv16_seed1_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_compare_curriculum_nenv16_seed1_1m/runs`
- TensorBoard：`outputs/tuned_compare_curriculum_nenv16_seed1_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_compare_curriculum_nenv16_seed1_1m/evaluations`
- 论文图：`outputs/tuned_compare_curriculum_nenv16_seed1_1m/figures`
...
curriculum  ppo     0.00      0.0            0.3926       0.00         1.00   1.0 158.5792
curriculum  ppo     0.08      0.0            0.2277       0.40         0.60   1.0  83.0354
curriculum  ppo     0.15      0.0            0.1809       0.74         0.26   1.0  66.3310
```
