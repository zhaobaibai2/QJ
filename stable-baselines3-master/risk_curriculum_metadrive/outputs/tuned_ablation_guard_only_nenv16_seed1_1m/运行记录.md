...
python scripts/run_suite.py --preset tuned_ablation_guard_only_nenv16_seed1_1m --device cuda
python scripts/plot_results.py --input-dir outputs/tuned_ablation_guard_only_nenv16_seed1_1m/evaluations --output-dir outputs/tuned_ablation_guard_only_nenv16_seed1_1m/figures --runs-dir outputs/tuned_ablation_guard_only_nenv16_seed1_1m/runs
python scripts/plot_trajectories.py --runs-dir outputs/tuned_ablation_guard_only_nenv16_seed1_1m/runs --output-dir outputs/tuned_ablation_guard_only_nenv16_seed1_1m/figures --algo ppo --seed 0 --density 0.25
python scripts/build_paper.py
```

## 主要输出

- 模型：`outputs/tuned_ablation_guard_only_nenv16_seed1_1m/runs`
- TensorBoard：`outputs/tuned_ablation_guard_only_nenv16_seed1_1m/runs/*/tensorboard`
- 评估 CSV：`outputs/tuned_ablation_guard_only_nenv16_seed1_1m/evaluations`
- 论文图：`outputs/tuned_ablation_guard_only_nenv16_seed1_1m/figures`
...
guard_only  ppo     0.00     0.96            0.9888       0.00          0.0  0.00 578.5271
guard_only  ppo     0.08     0.88            0.9341       0.10          0.0  0.10 548.5901
guard_only  ppo     0.15     0.66            0.8953       0.16          0.0  0.16 469.9622
```
