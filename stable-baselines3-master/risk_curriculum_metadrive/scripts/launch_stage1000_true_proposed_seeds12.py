#!/usr/bin/env python
"""Run original proposed PPO for seeds 1 and 2 for 1M steps."""
...
ROOT = Path("outputs/stage1000_true_proposed_multiseed")
...
def run_seed(seed: int) -> None:
    ...
    config.horizon = 1200
    config.n_envs = 4
    # Same proposed curriculum as the completed true seed0 run.
...
def main() -> None:
    ...
    commands = [
        ...
        ["scripts/write_run_report.py", "--experiment-root", str(ROOT), "--preset", "stage1000_true_proposed_multiseed"],
    ]
